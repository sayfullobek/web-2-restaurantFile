...
export const Statistick = () => {
    ...
    const statArr = [
        ...
        {name: "mahsulotlar", statistika: stat.productSize, icon: 'fas fa-chart-pie', about: 'mahsulotlar haqida'},
        {name: "sotib olishlar", statistika: stat.buySize, icon: 'fas fa-users', about: 'sotib olishlar soni'},
        {name: "kirimlar", statistika: stat.protcent, icon: 'fas fa-percent', about: 'kirimlar foizi'},
    ]
    return (
        <>
            {loading ? (
