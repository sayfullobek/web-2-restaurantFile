        ...
        <div>
            ...
            {product.length === 0 ? (
                ...
                <div>
                    ...
                    <div>
                        <textarea placeholder={"Manzilingizni kiritng"}
                                  style={{marginLeft: "100px", marginTop: "120px"}} name="adress" id="adress" cols="127"
                                  rows="3" onChange={e => setAdress(e.target.value)}/>
